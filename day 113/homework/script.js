...
const person = new Person("Giorgi", "Mindorashvili");
...
const person1 = new Person1("Giorgi", 16);
...
const person2 = new Person2("Giorgi", 70);
...
const product1 = new Product("fortoxali",1.60);
...
const product2 = new DiscountedProduct("fortoxali",20,10)
